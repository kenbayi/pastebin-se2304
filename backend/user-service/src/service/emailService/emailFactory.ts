        ...
        switch (type) {
            ...
            case 'updPassword':
                return{
                    ...
                    <body>
                        <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px;">
                            <tr><td style="text-align: center;"><h1 style="font-size: 24px; color: #333333;">Notification</h1></td></tr>
                            <tr><td style="text-align: center;"><p style="font-size: 16px; color: #555555;">Hi there, your password successfully updated, now you may log in, if it is not you, please contact us</p></td></tr>
                            <tr><td style="text-align: center; padding-top: 20px;"><p style="font-size: 12px; color: #aaaaaa;">&copy; 2024 Ilyas Kenbay. All rights reserved.</p></td></tr>
                        </table>
                    </body>
                    </html>
                `
